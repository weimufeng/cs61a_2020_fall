...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    neutral_city = make_city('neutral', lat, lon)
    distance_from_a = distance(city_a, neutral_city)
    distance_from_b = distance(city_b, neutral_city)
...
def construct_sent(word, table):
    ...
    while word not in ['.', '!', '?']:
        "*** YOUR CODE HERE ***"
        next_one = random.choice(table[word])
        result = result + ' ' + word
        word = next_one
